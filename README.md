...
## Section 5: GitHub Copilot Prompts for VS Code to verify POST properties
...
## Section 6: GitHub Copilot prompts for VS Code to connect to Azure Key Vault 

**NOTE:** Inspect the recommendations as generated by CoPilot. The prompt/response model requires some cognition 
...
**CAUTION:** Do **NOT** sendd secrets to the log, let's truncate, or better yet, let CoPilot help us **mask** the string 
...
Enable the Function for **authentication** and **authorization** to access Azure Key Vault, and secondly to **read** a secret: 
